...
namespace Persistence.Migrations.WalletsDb
{
    ...
    [Migration("20240605110159_UpdatedWalletSchemeAccountTransactionModel")]
    partial class UpdatedWalletSchemeAccountTransactionModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Wallets.LimitConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<decimal>("CumulativeLimit")
                        .HasPrecision(18, 2)
                    ...
                    b.ToTable("LimitConfigurations", null, t =>
                        {
                            t.HasComment("The table stores limit configuration records");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Wallets.Wallet", b =>
                {
                    ...
                    b.Property<Guid>("WalletSchemeId")
                        .HasMaxLength(50)
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("WalletSchemeId");
            ...
            modelBuilder.Entity("Domain.Entities.Wallets.WalletScheme", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("LimitConfigurationId")
                        .HasMaxLength(50)
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("WalletSchemeType")
                        .IsRequired()
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
                    ...
                    b.HasIndex("LimitConfigurationId");

                    b.ToTable("WalletSchemes", null, t =>
                        {
                            t.HasComment("The table stores wallet scheme information");
                        });
                });

            modelBuilder.Entity("Domain.Entities.Wallets.WalletSchemeAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WalletSchemeAccounts", null, t =>
                        {
            ...
            modelBuilder.Entity("Domain.Entities.Wallets.Wallet", b =>
                {
                    b.HasOne("Domain.Entities.Wallets.WalletScheme", "WalletScheme")
                        .WithMany()
                        .HasForeignKey("WalletSchemeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Wallets.WalletScheme", b =>
                {
                    b.HasOne("Domain.Entities.Wallets.LimitConfiguration", "LimitConfiguration")
                        .WithMany()
                        .HasForeignKey("LimitConfigurationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LimitConfiguration");
                });
